...
export default function RegDeskLogin() {
  ...
  // Quick fill helper for testing Help Desk
  const quickFillDesk = () => {
    setEmail('helpdesk@event.local');
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div>
            ...
            <input
              ...
              placeholder="4-digit event PIN (e.g. 4821)"
              maxLength={6}
            />
            <span style={{ fontSize: 11, color: '#64748B', marginTop: 3, display: 'block' }}>
              Physical station verification PIN. (Default: 4821)
            </span>
          </div>
        ...
        <div style={{
          ...
          <span style={{ fontSize: 11, color: '#64748B' }}>
            Test Officer: <code style={{ fontWeight: 800, color: '#065F46' }}>helpdesk@event.local</code>
          </span>
          <button
            type="button"
            onClick={quickFillDesk}
            style={{
